...
This is the second training stage where we are training with the addition of patches containing false positives. 
I used the trained model from before to obtain detections on the full sized training images (using infer.py), 
then I used the detection csv obtained and tools/patcher.py to get all patches these contain true positives and also 
false positives. I copied over all these patches (said no to file replacement) to the folder containing the original training
patches. Now I train with all of these patches using FolderDataset instead of CSVDataset. This makes all the false positive patches
as background.
...
train_dataset = FolderDataset(
    ...
    root_dir = '/home/tarun/Desktop/antcam/datasets/herdnet_ants_manual_annotation/train_patches_with_detections_for_HNP',
    albu_transforms = [
...
herdnet = load_model(herdnet, '/home/tarun/Desktop/HerdNet/output/best_model_with_mean_and_std.pth')


work_dir = '/home/tarun/Desktop/HerdNet/output_HNP'
mkdir(work_dir)
