...
def convert_to_yolo_labels(annotation_xml_file, folder_where_annotated_video_came_from, box_size, label):
	...
	for img in dictionary_of_boxes:
		...
		shutil.copy(img, '/home/tarun/Desktop/antcam/datasets/ants_manual_annotation/images/train/')
		...
		f = open('/home/tarun/Desktop/antcam/datasets/ants_manual_annotation/labels/train/' + img_name + '.txt', 'w')
